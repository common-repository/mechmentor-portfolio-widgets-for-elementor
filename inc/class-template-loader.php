 ...
 */
if ( ! class_exists( 'MPT_Template_Loader' ) ) {
	/**
	 * Template loader.
	 *
	 ...
	 */
	class MPT_Template_Loader {
		/**
		 * Prefix for filter names.
		 *
		 * @var string
		 */
		protected $filter_prefix = 'mpt_';
		/**
		 ...
		 * @var string
		 */
		protected $theme_template_directory = 'mechlin-portfolio';
		/**
		 ...
		 * @var string
		 */
		protected $plugin_directory = MPT_DIR;
		/**
